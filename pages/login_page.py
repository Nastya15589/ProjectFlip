...
class LoginPage(Base):
    ...
    # Actions
    def click_input_link(self):     # Нажимаем на Войти
        self.get_input_link().click()
        print("Click Input")

    def click_enter_with_password(self):        # Нажимаем на Войти с помощью пароля
        self.get_enter_with_password().click()
        print("Click enter with password")

    def input_mail(self):       # Вводим почту
        self.get_mail().send_keys("n54441863@gmail.com")
        print("Input mail")

    def input_password(self):       # Вводим пароль
        self.get_password().send_keys("n~9dQkYc8e=d~3P")
        print("Input password")

    def click_input_button(self):       # Нажимаем на кнопку войти
    ...
    def authorization(self):
        ...
        self.click_input_link()
        self.click_enter_with_password()
        self.input_mail()
        self.input_password()
        self.click_input_button()
        self.assert_word(self.get_account(), 'Анастасия')
